...
CREATE TABLE IF NOT EXISTS `bitchneldb`.`restaurant_gallery` (
  `idrestaurant_gallery_id` INT NOT NULL AUTO_INCREMENT,
  `restaurant_profile_id` INT NOT NULL,
  `restaurant_picture` BLOB NULL,
  PRIMARY KEY (`idrestaurant_gallery_id`),
